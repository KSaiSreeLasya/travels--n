...
export const SEO_META_DATA: Record<string, PageMeta> = {
  home: {
    ...
    canonical: "https://sreehanumantravels.com/",
    keywords: "Car Rentals Kadapa, Taxi Services Kadapa, Bus Rentals Kadapa, Tempo Traveller Rental Kadapa, Innova Crysta Rental Kadapa, Airport Taxi Kadapa",
  },
  carRentalServices: {
    ...
    canonical: "https://sreehanumantravels.com/car-rental-services",
  ...
  taxiServices: {
    ...
    canonical: "https://sreehanumantravels.com/taxi-services",
  ...
  tempoTravellerRentals: {
    ...
    canonical: "https://sreehanumantravels.com/tempo-traveller-rentals",
  ...
  busRentalServices: {
    ...
    canonical: "https://sreehanumantravels.com/bus-rental-services",
  ...
  airportTransfers: {
    ...
    canonical: "https://sreehanumantravels.com/airport-transfers",
  ...
  weddingVehicleRentals: {
    ...
    canonical: "https://sreehanumantravels.com/wedding-vehicle-rentals",
  ...
  tourPackages: {
    ...
    canonical: "https://sreehanumantravels.com/tour-packages",
  ...
  outstationCarRentals: {
    ...
    canonical: "https://sreehanumantravels.com/outstation-car-rentals",
  ...
  innovaCrystaRental: {
    ...
    canonical: "https://sreehanumantravels.com/innova-crysta-rental",
  ...
  corporateTravelServices: {
    ...
    canonical: "https://sreehanumantravels.com/corporate-travel-services",
  ...
  templeTourServices: {
    ...
    canonical: "https://sreehanumantravels.com/temple-tour-services",
  ...
  monthlyCarRental: {
    ...
    canonical: "https://sreehanumantravels.com/monthly-car-rental",
  ...
  luxuryVehicleRentals: {
    ...
    canonical: "https://sreehanumantravels.com/luxury-vehicle-rentals",
  ...
  contact: {
    ...
    canonical: "https://sreehanumantravels.com/contact",
